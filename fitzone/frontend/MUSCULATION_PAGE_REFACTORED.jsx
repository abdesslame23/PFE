...
// ============================================================
// Convertir la structure de la base de données
// ============================================================

function convertToMuscles() {
  const muscleOrder = ['Biceps', 'Triceps', 'Pectoraux', 'Dos', 'Épaules', 'Jambes', 'Abdominaux', 'Mollets'];
  const iconsMap = {
    'Biceps': 'bi-lightning-charge',
    'Triceps': 'bi-lightning',
    'Pectoraux': 'bi-person-arms-up',
    'Dos': 'bi-arrows-expand-vertical',
    'Épaules': 'bi-award',
    'Jambes': 'bi-activity',
    'Abdominaux': 'bi-grid-3x3',
    'Mollets': 'bi-arrow-up-circle'
  };
  const zonesMap = {
    'Biceps': 'Bras', 'Triceps': 'Bras', 'Pectoraux': 'Buste',
    'Dos': 'Dos', 'Épaules': 'Épaules', 'Jambes': 'Jambes',
    'Abdominaux': 'Core', 'Mollets': 'Jambes'
  };
  ...
  return muscleOrder.map((muscle, id) => ({
    id: id + 1,
    nom: muscle,
...
const muscles = convertToMuscles();
